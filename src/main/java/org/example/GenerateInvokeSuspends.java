...
public class GenerateInvokeSuspends implements Opcodes {
    ...
    public static byte[] dump () throws Exception {
        ...
        }
        {
            ...
            methodVisitor.visitTableSwitchInsn(0, 1, label14, new Label[] { label12, label13 });
            ...
            methodVisitor.visitLineNumber(9, label16);
            methodVisitor.visitVarInsn(ALOAD, 6);
            methodVisitor.visitInsn(ICONST_1);
            methodVisitor.visitFieldInsn(PUTFIELD, "io/ktor/samples/clientmultipart/MultipartAppKt$main$1$1", "label", "I");
            methodVisitor.visitMethodInsn(INVOKESTATIC, "io/ktor/samples/clientmultipart/MultipartAppKt", "doWorld", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", false);
            ...
            methodVisitor.visitLineNumber(8, label18);
            methodVisitor.visitVarInsn(ALOAD, 7);
            ...
            methodVisitor.visitLineNumber(11, label17);
            ...
            methodVisitor.visitLocalVariable("this", "Lio/ktor/samples/clientmultipart/MultipartAppKt$main$1$1;", null, label15, label14, 6);
            methodVisitor.visitLocalVariable("$result", "Ljava/lang/Object;", null, label15, label14, 5);
            methodVisitor.visitLocalVariable("weaverError", "Ljava/lang/Throwable;", null, label7, label10, 4);
            methodVisitor.visitLocalVariable("weaverError", "Ljava/lang/Throwable;", null, label23, label26, 4);
            methodVisitor.visitLocalVariable("this", "Lkotlin/coroutines/jvm/internal/BaseContinuationImpl;", null, label5, label22, 0);
            methodVisitor.visitLocalVariable("obj", "Ljava/lang/Object;", null, label5, label22, 1);
            methodVisitor.visitLocalVariable("weaveOriginalReturnValue", "Ljava/lang/Object;", null, label0, label27, 3);
            methodVisitor.visitLocalVariable("weaveThrowableWasThrown", "Z", null, label0, label27, 2);
